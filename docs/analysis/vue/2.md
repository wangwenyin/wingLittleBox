...
这是 Vue 2 源码阅读系列的第 2 篇，重点理解虚拟 DOM 在 Vue 里承担什么职责，以及一个 VNode 节点内部到底记录了哪些信息。

## 阅读提示

- 如果你刚看完响应式原理，可以把这篇理解成“数据变化后，Vue 要拿什么去描述视图”
- 本篇先解决 VNode 是什么，下一篇再进入 patch 和 diff
- 阅读时优先关注字段职责，不必急着记住所有构造细节
...
- 为什么 Vue 需要 VNode 这层抽象
- 一个 VNode 节点内部保存了哪些关键信息
- 模板、组件和文本最终是怎样被组织成虚拟节点的

## 继续阅读

- 上一篇：[Vue 响应式原理](/analysis/vue/1)
- 下一篇：[VirtualDOM与diff](/analysis/vue/3)
